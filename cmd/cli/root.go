...
var rootCmd = &cobra.Command{
	Use:   "Jira-connector",
	Short: "Jira Connector is connector service for Jira tasks",
	Long: `Jira Connector need config file,
that contains information about Jira, DB,
Broker service, and app configuration.
